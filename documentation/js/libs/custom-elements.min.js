(function () {
  ...
  function da(b) {
    if (!1 !== b.g) {
      b.g = !1;
      for (var a = b.m, c = [], d = new Map(), e = 0; e < a.length; e++) d.set(a[e].localName, []);
      C(b.c, document, {
        i: function (a) {
          if (void 0 === a.__CE_state) {
            var e = a.localName,
  ...
  function Y(b, a, c) {
    function d(a) {
      return function (c) {
        for (var e = [], d = 0; d < arguments.length; ++d) e[d - 0] = arguments[d];
        for (var d = [], f = [], l = 0; l < e.length; l++) {
          var q = e[l];
          q instanceof Element && n(q) && f.push(q);
          if (q instanceof DocumentFragment) for (q = q.firstChild; q; q = q.nextSibling) d.push(q);
          else d.push(q);
        }
        a.apply(this, e);
        for (e = 0; e < f.length; e++) B(b, f[e]);
        if (n(this)) for (e = 0; e < d.length; e++) (f = d[e]), f instanceof Element && z(b, f);
      };
    }
    c.h && (a.prepend = d(c.h));
          ...
          if (this.nodeType === Node.TEXT_NODE) d.set.call(this, a);
            ...
            if (this.firstChild) {
              var c = this.childNodes,
                k = c.length;
              if (0 < k && n(this)) for (var e = Array(k), g = 0; g < k; g++) e[g] = c[g];
            }
            d.set.call(this, a);
  ...
  function ya(b) {
    ...
    function c(a) {
      return function (e) {
        ...
        for (var d = [], k = [], g = 0; g < c.length; g++) {
          ...
          if (l instanceof DocumentFragment) for (l = l.firstChild; l; l = l.nextSibling) d.push(l);
          else d.push(l);
        }
        a.apply(this, c);
        for (c = 0; c < k.length; c++) B(b, k[c]);
        if (n(this)) for (c = 0; c < d.length; c++) (k = d[c]), k instanceof Element && z(b, k);
      };
    }
    V && (a.before = c(V));
    V && (a.after = c(pa));
    qa &&
      u(a, 'replaceWith', function (a) {
        for (var e = [], c = 0; c < arguments.length; ++c) e[c - 0] = arguments[c];
        ...
        if (k)
          for (B(b, this), e = 0; e < c.length; e++) (d = c[e]), d instanceof Element && z(b, d);
      });
    ra &&
      u(a, 'remove', function () {
        var a = n(this);
        ...
        : w(b, function (b) {
            a(b, {
              ...
              set: function (a) {
                ...
                for (c.innerHTML = a; 0 < e.childNodes.length; ) M.call(e, e.childNodes[0]);
                for (a = b ? c.content : c; 0 < a.childNodes.length; ) K.call(e, a.childNodes[0]);
              },
            });
          });
