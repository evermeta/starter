...
!(function (t, e) {
          ...
          if (1 === _e3.nodeType) {
            if (_e3.hasAttributes()) {
              ...
              for (; _o-- > 0; ) {
                ...
                _this.parts.push({ type: 'attribute', index: s, name: _o2, strings: _a }),
            ...
            if (_t2.indexOf(l) >= 0) {
              ...
              for (var _t3 = 0; _t3 < _a2; _t3++) {
                _o3.insertBefore('' === _r2[_t3] ? m() : document.createTextNode(_r2[_t3]), _e3),
                  _this.parts.push({ type: 'node', index: ++s });
              }
              '' === _r2[_a2] ? (_o3.insertBefore(m(), _e3), n.push(_e3)) : (_e3.data = _r2[_a2]),
                (i += _a2);
            }
          } else if (8 === _e3.nodeType)
            if (_e3.data === l) {
              var _t4 = _e3.parentNode;
              (null !== _e3.previousSibling && s !== h) || (s++, _t4.insertBefore(m(), _e3)),
                (h = s),
                _this.parts.push({ type: 'node', index: s }),
            ...
            for (; s < e.length && null !== r; ) {
              ...
              if (p(_t8)) {
                if (n === _t8.index) {
                  var _this2$_parts;
                  if ('node' === _t8.type) {
                    var _t9 = _this2.processor.handleTextExpression(_this2.options);
                    _t9.insertAfterNode(r.previousSibling), _this2._parts.push(_t9);
                  } else
        ...
        value: function getHTML() {
          ...
          for (var _s2 = 0; _s2 < t; _s2++) {
            var _t10 = this.strings[_s2],
              _i2 = g.exec(_t10);
            e += _i2 ? _t10.substr(0, _i2.index) + _i2[1] + _i2[2] + c + _i2[3] + l : _t10 + h;
          }
  ...
  var x = (function (_f) {
    ...
    _createClass(x, [
      ...
      },
      {
        key: 'getTemplateElement',
        value: function getTemplateElement() {
          var t = _get(_getPrototypeOf(x.prototype), 'getTemplateElement', this).call(this),
            e = t.content,
            s = e.firstChild;
        ...
        value: function _getValue() {
          ...
          for (var _i3 = 0; _i3 < e; _i3++) {
            ...
            if (void 0 !== _e4) {
              ...
              if (
                null != _t12 &&
                (Array.isArray(_t12) || ('string' != typeof _t12 && _t12[Symbol.iterator]))
              ) {
    ...
    _createClass(V, [
        ...
        value: function _commitText(t) {
          ...
          (t = null == t ? '' : t),
            e === this.endNode.previousSibling && 3 === e.nodeType
              ? (e.data = t)
              : this._commitNode(document.createTextNode('string' == typeof t ? t : String(t))),
            (this.value = t);
        },
      },
      {
        ...
        value: function _commitTemplateResult(t) {
          ...
          if (this.value instanceof v && this.value.template === e) this.value.update(t.values);
          else {
      ...
      },
      {
        ...
        value: function clear() {
          var t =
            arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.startNode;
  ...
  function M(t) {
    var e = L.get(t.type);
    void 0 === e && ((e = { stringsArray: new WeakMap(), keyString: new Map() }), L.set(t.type, e));
  ...
  (t.html = function (t) {
    for (
      var _len = arguments.length, e = new Array(_len > 1 ? _len - 1 : 0), _key = 1;
      _key < _len;
      _key++
    ) {
    ...
    (t.svg = function (t) {
      for (
        var _len2 = arguments.length, e = new Array(_len2 > 1 ? _len2 - 1 : 0), _key2 = 1;
        _key2 < _len2;
        _key2++
      ) {
