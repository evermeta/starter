var BSN = (function (H) {
  ...
  const at = (t, s) => t.getAttribute(s),
    ...
    E = t => (ns(t) ? t.document : Ks(t) ? t : A(t) ? t.ownerDocument : window.document),
  ...
  const Kt = new Map(),
    Zs = (t, s) => {
      ...
      if (s) {
        const n = Zs(t),
          o = Kt.get(n) || new Map();
        Kt.has(n) || Kt.set(n, o), os(o) && !o.has(s) ? (o.set(s, e), (qs += 1)) : (e = o.get(s));
      } else {
        const n = t.id || t;
  ...
  class st {
    constructor(s, e) {
      ...
      o && o._toggleEventListeners(),
        (this.element = n),
        (this.options =
          this.defaults && Ys(this.defaults).length ? ti(n, this.defaults, e || {}, 'bs') : {}),
  ...
  class Ut extends st {
    constructor(e) {
      ...
      d(this, 'close', () => {
        ...
        e &&
          h(e, m) &&
          (w(e, sn), sn.defaultPrevented || (b(e, m), h(e, W) ? P(e, () => nn(this)) : nn(this)));
      });
  ...
  class qt extends st {
    constructor(e) {
      ...
      (this.isActive = h(n, C)), O(n, _s, String(!!this.isActive)), this._toggleEventListeners(!0);
    }
    get name() {
      return on;
    }
    ...
    constructor(e, n) {
      ...
      d(this, '_toggleEventListeners', e => {
        ...
        r && g && (v(n, De, wi), v(n, Ze, Ei)),
          l &&
            i.length > 2 &&
            (v(n, Fo, Ci, tt), v(n, Ge, dn, { passive: !1 }), v(n, Vo, dn, { passive: !1 })),
          c.length &&
            c.forEach(k => {
              k && v(k, N, Ti);
            }),
      ...
      (this.direction = Et(o) ? 'right' : 'left'), (this.isTouch = !1), (this.slides = gt(Q, o));
      const { slides: i } = this;
      if (i.length >= 2) {
        const c = fs(this),
        ...
        this.index = c;
        const l = E(o);
        (this.controls = [...et(`[${$t}]`, o), ...et(`[${$t}][${cs}="#${o.id}"]`, l)].filter(
          (g, p, v) => p === v.indexOf(g),
        )),
        ...
        (this.options.interval = r.interval === !0 ? rn.interval : r.interval),
          a
            ...
            : c < 0 && ((this.index = 0), f(i[0], C), this.indicators.length && hs(this, 0)),
    ...
    to(e) {
      ...
      if (!this.isAnimating && c !== l && !u.get(n, $t)) {
        c < l || (c === 0 && l === o.length - 1)
          ...
          : (c > l || (c === o.length - 1 && l === 0)) && (this.direction = a ? 'left' : 'right');
            ...
            zt(o[l]) && h(n, 'slide')
              ? u.set(
                  ...
                  () => {
                    f(o[l], `${Q}-${g}`),
                      ...
                      f(o[l], `${Q}-${p}`),
                      f(o[c], `${Q}-${p}`),
                      P(o[l], () => this.slides && this.slides.length && ln(this));
                  },
                  0,
                  $t,
                )
              : (f(o[l], C),
                ...
                u.set(
                  n,
                  () => {
                    u.clear(n, $t), n && i.interval && !this.isPaused && this.cycle(), w(n, ds);
                  },
                  0,
                  $t,
                )));
  ...
  class Zt extends st {
    constructor(e, n) {
      ...
      (this.triggers = [...et(gn, c)].filter(a => V(a) === o)),
        (this.parent = T(i.parent) ? i.parent : he(i.parent) ? V(o) || D(i.parent, c) : null),
        this._toggleEventListeners(!0);
    }
    get name() {
      return fn;
  ...
  const Ot = ['dropdown', 'dropup', 'dropstart', 'dropend'],
    ...
    Pn = t => {
      ...
      if (z(e, 'position') !== 'static') {
        ...
        L(e, { ...p[r], margin: `${Ht.map(R => R && `${R}px`).join(' ')}` }),
          $n.includes(r) && a && a && L(e, p[(!c && x) || (c && ae) ? 'menuStart' : 'menuEnd']),
          w(n, Hn);
      }
    },
    _i = t =>
    ...
    We = t => {
      const s = [...Ot, 'btn-group', 'input-group']
        .map(e => gt(`${e} ${m}`, E(t)))
        .find(e => e.length);
      if (s && s.length) return [...s[0].children].find(e => Ot.some(n => n === at(e, rt)));
    },
    xn = t => {
  ...
  const U = 'modal',
    ...
    An = 'sticky-top',
    Ln = 'position-sticky',
    In = t => [...gt(ji, t), ...gt(zi, t), ...gt(An, t), ...gt(Ln, t), ...gt('is-fixed', t)],
    Vi = t => {
      const s = wt(t);
      ...
      s &&
        ...
        c.length &&
          c.forEach(a => {
            ...
            if (
              ((a.style.paddingRight = `${parseInt(l, 10) + i}px`), [An, Ln].some(r => h(a, r)))
            ) {
    ...
    Vn = t => T(t) && z(t, 'visibility') !== 'hidden' && t.offsetParent !== null,
    Ki = `.${U}`,
    Kn = `[${rt}="${U}"]`,
    Xi = `[${Me}="${U}"]`,
    Xn = `${U}-static`,
  ...
  class te extends st {
    ...
    show() {
      ...
      if (!h(e, m) && ((je.relatedTarget = i || void 0), w(e, je), !je.defaultPrevented)) {
        ...
        c
          ? (Es(I) ? Ts(!0) : Fn(e, o, !0), (a = zt(I)), jn(), setTimeout(() => Jn(this), a))
          : (Jn(this), l && h(I, m) && Fe());
      }
    }
    hide() {
  ...
  const Ji = `.${Z}`,
    ...
    cc = t => {
      ...
      if (o) {
        ...
        (!I.contains(s) || a !== 'static') &&
          (!(r && r.toString().length) &&
            ((!e.contains(s) && a && (!l || c.includes(s))) || (n && n.contains(s))) &&
    ...
    ac = ({ code: t, target: s }) => {
      const e = D($s, E(s)),
        n = e && me(e);
      n && n.options.keyboard && t === es && ((n.relatedTarget = null), n.hide());
    },
    rc = t => {
      const { element: s } = t;
  ...
  const _t = 'popover',
      ...
      if (n) {
        ...
        ($e = Ye.includes(y) ? Ht + Y / 2 - p / 2 - xt < 0 : $e),
          ...
          T(c) &&
            ...
            Xe !== '' ? (c.style.left = `${Xe}px`) : Ns !== '' && (c.style.right = `${Ns}px`));
    ...
    hc = t => {
      const s = ['HTML', 'BODY'],
        e = [];
      let { parentNode: n } = t;
      for (; n && !s.includes(n.nodeName); ) (n = si(n)), Us(n) || ci(n) || e.push(n);
      return (
        e.find((o, i) =>
  ...
  class St extends st {
    constructor(e, n) {
      ...
      (!l.title && i) ||
        ...
        (this.container = hc(o)),
        (this.offsetParent = ['sticky', 'fixed'].some(r => z(this.container, 'position') === r)
          ? this.container
          : E(this.element).body),
        dc(this),
        this._toggleEventListeners(!0));
    ...
    show() {
      const { options: e, tooltip: n, element: o, container: i, offsetParent: c, id: a } = this,
        { animation: l } = e,
        r = u.get(o, 'out'),
        g = i === c ? i : c;
      u.clear(o, 'out'),
        ...
        n &&
          ...
          u.set(
            ...
            () => {
              ...
              w(o, a),
                a.defaultPrevented ||
                  (this.update(), b(n, m), po(this), i ? P(n, () => go(this)) : go(this));
            },
            c + 17,
            'out',
          );
  ...
  const Ec = 'scrollspy',
    ...
    Hc = ({ element: t, scrollTarget: s }) => (ns(s) ? s.innerHeight : fe(t).height),
    wo = t => {
      [...is('A', t)].forEach(s => {
        h(s, C) && b(s, C);
      });
    ...
    constructor(e, n) {
      ...
      d(this, 'refresh', () => {
        ...
        if (T(e) && e.offsetHeight > 0) {
          ...
          c.forEach((r, g) => {
            a !== r && n >= l[g] && (typeof l[g + 1] > 'u' || n < l[g + 1]) && Eo(this, r);
          });
        }
      });
      d(this, '_toggleEventListeners', e => {
  ...
  const be = 'tab',
    ...
    Do = t => {
      const { element: s, content: e, tabContent: n, nav: o } = t,
        { tab: i, content: c } = (o && we.get(o)) || { tab: null, content: null };
      let a = 0;
      if (
        (n &&
          e &&
