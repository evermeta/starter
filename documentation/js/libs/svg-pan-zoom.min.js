      ...
      function (t, e, o) {
        ...
        e.exports = {
          enable: function (t) {
            ...
            if (
              (e || ((e = document.createElementNS(s.svgNS, 'defs')), t.svg.appendChild(e)),
              !e.querySelector('style#svg-pan-zoom-controls-styles'))
            ) {
            ...
            n.setAttribute('id', 'svg-pan-zoom-controls'),
              n.setAttribute(
                'transform',
                'translate(' + (t.width - 70) + ' ' + (t.height - 76) + ') scale(0.75)',
              ),
              n.setAttribute('class', 'svg-pan-zoom-control'),
              n.appendChild(this._createZoomIn(t)),
              n.appendChild(this._createZoomReset(t)),
              n.appendChild(this._createZoomOut(t)),
              t.svg.appendChild(n),
              (t.controlIcons = n);
          },
          _createZoomIn: function (t) {
            ...
            return (
              ...
              n.setAttribute('class', 'svg-pan-zoom-control-element'),
              e.appendChild(n),
              e
            );
          },
      ...
      function (t, e, o) {
        ...
        (n.prototype.init = function (t, e) {
          (this.viewport = t),
            ...
            (this.updateCTMCached = r.proxy(this.updateCTM, this)),
            (this.requestAnimationFrame = r.createRequestAnimationFrame(this.options.refreshRate)),
          ...
          (n.prototype.processCTM = function () {
            var t,
              e = this.getCTM();
            (this.options.fit || this.options.contain) &&
              ((t = this.options.fit
                ? Math.min(
                    this.options.width / this.viewBox.width,
                    this.options.height / this.viewBox.height,
            ...
            if (this.options.center) {
              var o = 0.5 * (this.options.width - (this.viewBox.width + 2 * this.viewBox.x) * e.a),
                n = 0.5 * (this.options.height - (this.viewBox.height + 2 * this.viewBox.y) * e.a);
              (e.e = o), (e.f = n);
            }
            return (
              (this.originalState.zoom = e.a),
          ...
          (n.prototype.setCTM = function (t) {
            ...
            if (e || o) {
              if (
                (e &&
                  (!1 ===
                  this.options.beforeZoom(this.getRelativeZoom(), this.computeRelativeZoom(t.a))
                    ? ((t.a = t.d = this.activeState.zoom), (e = !1))
                    : (this.updateCache(t), this.options.onZoom(this.getRelativeZoom()))),
                o)
              ) {
                var n = this.options.beforePan(this.getPan(), { x: t.e, y: t.f }),
                  ...
                  s = !1;
                !1 === n
                  ? ((t.e = this.getPan().x), (t.f = this.getPan().y), (i = s = !0))
                  : r.isObject(n) &&
                    (!1 === n.x
                      ? ((t.e = this.getPan().x), (i = !0))
                      : r.isNumber(n.x) && (t.e = n.x),
                    !1 === n.y
                      ? ((t.f = this.getPan().y), (s = !0))
                      : r.isNumber(n.y) && (t.f = n.y)),
                  (i && s) || !this.isPanDifferent(t)
                    ? (o = !1)
          ...
          (n.prototype.updateCTM = function () {
            var t = this.getCTM();
            i.setCTM(this.viewport, t, this.defs),
      ...
      function (t, e, o) {
        ...
        (i.prototype.init = function (t, e) {
          ...
          (this.svg = t),
            ...
            (this.options = r.extend(r.extend({}, u), e)),
            (this.state = 'none');
          var n = a.getBoundingClientRectNormalized(t);
          (this.width = n.width),
            (this.height = n.height),
            (this.viewport = l(a.getOrCreateViewport(this.svg, this.options.viewportSelector), {
              svg: this.svg,
              width: this.width,
              height: this.height,
          ...
          i.setBeforeZoom(this.options.beforeZoom),
            ...
            this.options.controlIconsEnabled && s.enable(this),
            ...
            if (
              ...
              if (t && t.length)
                for (var e = t.length - 1; 0 <= e; e--)
                  this.eventListeners.hasOwnProperty(t[e]) && delete this.eventListeners[t[e]];
            }
          ...
          (i.prototype.enableMouseWheelZoom = function () {
            if (!this.options.mouseWheelZoomEnabled) {
              ...
              n.on(this.options.eventsListenerElement || this.svg, this.wheelListener, t),
          ...
          (i.prototype.disableMouseWheelZoom = function () {
            if (this.options.mouseWheelZoomEnabled) {
              var t = !this.options.preventMouseEventsDefault;
              n.off(this.options.eventsListenerElement || this.svg, this.wheelListener, t),
          ...
          (i.prototype.handleMouseWheel = function (t) {
            if (this.options.zoomEnabled && 'none' === this.state) {
              ...
              (this.lastMouseWheelEventTime = Date.now()),
                ...
                (e = -0.3 < e && e < 0.3 ? e : ((0 < e ? 1 : -1) * Math.log(Math.abs(e) + 10)) / n);
          ...
          (i.prototype.handleDblClick = function (t) {
            ...
            if (
              ...
              -1 < (t.target.getAttribute('class') || '').indexOf('svg-pan-zoom-control')
            )
              return !1;
            e = t.shiftKey
          ...
          (i.prototype.handleMouseDown = function (t, e) {
            this.options.preventMouseEventsDefault &&
              (t.preventDefault ? t.preventDefault() : (t.returnValue = !1)),
              r.mouseAndTouchNormalize(t, this.svg),
              this.options.dblClickZoomEnabled && r.isDblClick(t, e)
          ...
          (i.prototype.destroy = function () {
            var e = this;
            for (var t in ((this.beforeZoom = null),
            (this.onZoom = null),
            (this.beforePan = null),
            (this.onPan = null),
            (this.onUpdatedCTM = null) != this.options.customEventsHandler &&
                ...
                (this.publicInstance = this.pi =
                  {
                    ...
                    setBeforePan: function (t) {
                      return (
                        (o.options.beforePan = null === t ? null : r.proxy(t, o.publicInstance)),
                        o.pi
                      );
                    },
                    setOnPan: function (t) {
                      return (
                        (o.options.onPan = null === t ? null : r.proxy(t, o.publicInstance)), o.pi
                      );
                    },
                    enableZoom: function () {
                    ...
                    enableControlIcons: function () {
                      return (
                        o.options.controlIconsEnabled ||
                          ((o.options.controlIconsEnabled = !0), s.enable(o)),
                        o.pi
                      );
                    },
                    disableControlIcons: function () {
                      return (
                        o.options.controlIconsEnabled &&
                          ((o.options.controlIconsEnabled = !1), s.disable(o)),
                        o.pi
                      );
                    },
                    ...
                    setBeforeZoom: function (t) {
                      return (
                        (o.options.beforeZoom = null === t ? null : r.proxy(t, o.publicInstance)),
                        o.pi
                      );
                    },
                    setOnZoom: function (t) {
                      return (
                        (o.options.onZoom = null === t ? null : r.proxy(t, o.publicInstance)), o.pi
                      );
                    },
                    zoom: function (t) {
                    ...
                    zoomAtPoint: function (t, e) {
                      return o.publicZoomAtPoint(t, e, !0), o.pi;
                    },
                    zoomAtPointBy: function (t, e) {
                    ...
                    setOnUpdatedCTM: function (t) {
                      return (
                        (o.options.onUpdatedCTM = null === t ? null : r.proxy(t, o.publicInstance)),
                        o.pi
                      );
                    },
                    resetZoom: function () {
        ...
        e.exports = function (t, e) {
          ...
          return (
            c.push({ svg: o, instance: new i(o, e) }), c[c.length - 1].instance.getPublicInstance()
          );
        };
      },
      {
          ...
          (e.exports = {
            ...
            getOrCreateViewport: function (t, e) {
              ...
              if (!(o = l.isElement(e) ? e : t.querySelector(e))) {
                ...
                1 === n.length &&
                  'g' === n[0].nodeName &&
                  null === n[0].getAttribute('transform') &&
                  (o = n[0]);
              }
              if (!o) {
                ...
                if (s && 0 < s.length)
                  for (var r = s.length; 0 < r; r--)
                    'defs' !== s[s.length - r].nodeName && o.appendChild(s[s.length - r]);
                t.appendChild(o);
              }
              var a = [];
              return (
                o.getAttribute('class') && (a = o.getAttribute('class').split(' ')),
                ~a.indexOf('svg-pan-zoom_viewport') ||
                  (a.push('svg-pan-zoom_viewport'), o.setAttribute('class', a.join(' '))),
                o
              );
            },
            setupSvgAttributes: function (t) {
              if (
                ...
                -1 === e.toLowerCase().indexOf('overflow') &&
                  t.setAttribute('style', 'overflow: hidden; ' + e);
              }
            },
            internetExplorerRedisplayInterval: 300,
            refreshDefsGlobal: l.throttle(
              function () {
            ...
            setCTM: function (t, e, o) {
              ...
              t.setAttributeNS(null, 'transform', i),
                'transform' in t.style
                  ? (t.style.transform = i)
                  : '-ms-transform' in t.style
                    ? (t.style['-ms-transform'] = i)
                    : '-webkit-transform' in t.style && (t.style['-webkit-transform'] = i),
                'ie' === s &&
                  o &&
      ...
      function (t, e, o) {
        ...
        e.exports =
          ...
          window.addEventListener
            ? ((s = 'addEventListener'), (r = 'removeEventListener'))
            : ((s = 'attachEvent'), (r = 'detachEvent'), (l = 'on')),
          (a =
      ...
      function (t, e, o) {
        ...
        e.exports = {
          ...
          throttle: function (o, n, i) {
            ...
            return function () {
              ...
              return (
                ...
                (r = arguments),
                e <= 0 || n < e
                  ? (clearTimeout(u), (u = null), (h = t), (a = o.apply(s, r)), u || (s = r = null))
                  : u || !1 === i.trailing || (u = setTimeout(c, e)),
                a
              );
            };
          },
          createRequestAnimationFrame: function (t) {
            var e = null;
            return (
              'auto' !== t && t < 60 && 1 < t && (e = Math.floor(1e3 / t)),
