...
!(function () {
  ...
  (e.version = '2.3.9'),
    ...
    (e.FieldRef.prototype.toString = function () {
      return (
        void 0 == this._stringValue &&
          (this._stringValue = this.fieldName + e.FieldRef.joiner + this.docRef),
        this._stringValue
      );
    }),
    (e.Set = function (e) {
    ...
    (e.TokenSet.prototype.intersect = function (t) {
      for (
        var r = new e.TokenSet(), i = void 0, n = [{ qNode: t, output: r, node: this }];
        n.length;
    ...
    (e.TokenSet.Builder.prototype.insert = function (t) {
      ...
      for (
        var n = 0;
        n < t.length && n < this.previousWord.length && t[n] == this.previousWord[n];
        n++
      )
        i++;
      this.minimize(i),
    ...
    (e.Builder.prototype.calculateAverageFieldLengths = function () {
      for (
        var t = Object.keys(this.fieldLengths), r = t.length, i = {}, n = {}, s = 0;
        s < r;
        s++
      ) {
    ...
    (e.QueryLexer.lexEditDistance = function (t) {
      return (
        t.ignore(), t.acceptDigitRun(), t.emit(e.QueryLexer.EDIT_DISTANCE), e.QueryLexer.lexText
      );
    }),
    ...
    (e.QueryLexer.lexText = function (t) {
      for (;;) {
        ...
        if (92 != r.charCodeAt(0)) {
          ...
          if ('~' == r)
            return (
              t.backup(), t.width() > 0 && t.emit(e.QueryLexer.TERM), e.QueryLexer.lexEditDistance
            );
          if ('^' == r)
